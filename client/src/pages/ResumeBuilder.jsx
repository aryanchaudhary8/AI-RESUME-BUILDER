        ...
        <div>
            ...
            <div className="max-w-7xl mx-auto px-4 pb-8">
                <div className="grid lg:grid-cols-12 gap-8">
                    {/* Left Panel - Form */}
                    <div className="relative lg:col-span-5 rounded-lg overflow-visible mt-2">
                        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
                            ...
                            <div className="flex justify-between items-center mb-6 border-b border-gray-300 py-1">
                                <div className='relative overflow-visible flex items-center gap-2'>
                                    <TemplateSelector
                                ...
                                <div className="flex items-center">
                                    {activeSectionIndex !== 0 && (
                                        <button onClick={() => setActiveSectionIndex((prevInd) => Math.max(prevInd - 1, 0))} className="flex items-center gap-1 p-3 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 transition-all" disabled={activeSectionIndex === 0}>
