        ...
        <div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                <div className="flex gap-4">
                    ...
                    <button onClick={() => setshowUploadResumes(true)} className="w-full bg-white sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-600 border border-dashed border-slate-300 group hover:border-purple-500 hover:shadow-lg transition-all duration-300 cursor-pointer">
            ...
            {/* BOTTOM RESUMES SECTION (FIXED ALIGNMENT) */}
            <div className="max-w-7xl mx-auto px-4">
                                ...
                                >
                                    ...
                                    <PencilIcon
                                        onClick={(e) => {
                                            ...
                                            seteditResumeId(resume._id);  // open modal
                                            setTitle(resume.title);       // prefill input
                                        }}
                ...
                {showCreateResumes && (
                    <form onSubmit={createResume} onClick={() => setshowCreateResumes(false)} className="fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50 z-10 flex items-center justify-center">
                        <div onClick={(e) => e.stopPropagation()} className="relative bg-slate-50 border shadow-lg rounded-lg p-6 w-full max-w-sm">
                ...
                {editResumeId && (
                    ...
                    >
                        <form
                            onSubmit={editTitle}
                            onClick={(e) => e.stopPropagation()}
                            className="relative bg-slate-50 border shadow-lg rounded-lg p-6 w-full max-w-sm"
                        >
